...
*Cause: QUITAR LA COMA ANTES DE LA PRIMERA CONSTRAINT, EL VARCHAR DEL OFICIO ES MUY PEQUEÑO
*Action:QUITAR LA COMA PARA INTRODUCIR LA CONSTRAINT, AUMENTAR EL VALOR DEL VARCHAR DE OFICIO
*/
